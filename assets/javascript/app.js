...
$(document).ready(function () {
    ...
    $(".spotify-link").on("click", function () {
        ...
        if (!$(".location-search").val()) {
            ...
            $('.spotify-link').attr('href', 'https://accounts.spotify.com/en/authorize?response_type=token&client_id=ca5834e480c6461fba72bb35632ecead&redirect_uri=https:%2F%2Ftzlomke.github.io%2Fgigify%2F&scope=user-top-read%20user-library-read&state=123');
        };
    });
